...
void second_straight_factory_init(){
	...
	target_tail_angle=0;
	gyroOffsetRevise=0;
	RunningMethod_init(&secondStraightLineTraceMethod,balancing_requrement,use_controller,target_tail_angle, gyroOffsetRevise,switch_term,DistanceSwitch_judge_switch_method);
