...
void first_curve_factory_init(){
	...
	curveLineTraceMethod.switch_term.distance = 100000;//1649.60;
	...
	curveLineTraceMethod.use_controller.target_light_controller_weight = 1.0;
	...
	firstCurve.target_values.target_speed=100;
