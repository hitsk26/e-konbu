...
void slope_factory_init(){
	...
	slopeRunningMethod.use_controller.target_curvature_controller_weight= 1.0;
	slopeRunningMethod.use_controller.target_light_controller_weight = 0.0;
	...
	slope.target_values.target_curvature=1.0/700.0;
