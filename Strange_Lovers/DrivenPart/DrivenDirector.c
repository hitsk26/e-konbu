...
logSend(0,0,DistanceEncoder_get_distance(&distanceEncoder),InclinationEncoder_get_inclination(&inclinationEncoder),brightness_turn,BrightnessEncoder_get_brightness_normalize(&brightnessEncoder)*1000,0,0);
